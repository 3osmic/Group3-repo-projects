...
class Context:
    ...
    control special execution BehaveTesting such as reading data from
...
class Option(Parameter):
    ...
    have some extra BehaveTesting that arguments don't have.
...
class Argument(Parameter):
    ...
    provide fewer BehaveTesting than options but can have infinite ``nargs``
